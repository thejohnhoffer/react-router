 ...
 */
export declare function HashRouter({ basename, hashType, children, window }: HashRouterProps): JSX.Element;
 ...
 */
export declare function useSearchParams(defaultInit?: URLSearchParamsInit): readonly [any, any];
